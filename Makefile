...
APPS = nsqd nsqlookupd nsqadmin nsq_to_nsq nsq_to_file nsq_to_http nsq_to_elasticsearch nsq_tail nsq_stat to_nsq
all: $(APPS)
...
$(BLDDIR)/nsq_to_elasticsearch: $(wildcard apps/nsq_to_elasticsearch/*.go nsq/*.go internal/*/*.go)
